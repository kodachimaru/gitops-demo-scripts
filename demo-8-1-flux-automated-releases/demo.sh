...
# Add it to GitHub repo, with read/write access
kubectl -n flux logs deployment/flux | grep identity.pub | cut -d '"' -f2
# Can also get it using Flux's CLI tool!
...
# Watch HelmOperator
kubectl logs -f $(kubectl get pods -n flux -o name | grep flux-helm-operator) -n flux
